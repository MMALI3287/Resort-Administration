 ...
 * @author USER
 */
public class ResortSlide extends javax.swing.JFrame {
    ...
    public ResortSlide() {
        initComponents();
        try {
            imgs[0] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\0.jpg"));
            imgs[1] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\1.jpg"));
            imgs[2] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\2.jpg"));
            imgs[3] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\3.jpg"));
            imgs[4] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\4.jpg"));
            imgs[5] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\5.jpg"));
            imgs[6] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\6.jpg"));
            imgs[7] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\7.jpg"));
            imgs[8] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\8.jpg"));
            imgs[9] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\9.jpg"));
            imgs[10] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\10.jpg"));
            imgs[11] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\11.jpg"));
            imgs[12] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Slider\\12.jpg"));
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(215, 210, 206));
        kGradientPanel1.setkGradientFocus(600);
        kGradientPanel1.setkStartColor(new java.awt.Color(147, 187, 189));
        ...
        jLabel9.setText("WELCOME TO TEMPA RESORT");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResortSlide.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResortSlide().setVisible(true);
            }
        });
    }
