 ...
 * @author USER
 */
public class CottageBookings extends javax.swing.JFrame {

    /**
     * Creates new form CottageBookings
     */
    DefaultTableModel model = new DefaultTableModel();

    public CottageBookings() {
        initComponents();
        setRecordsToTable();
    }
    ...
    public void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection
                    .prepareStatement("SELECT * FROM book_cot;");
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                String cot = Welcome.jdbc.resultSet.getString("cot");
                Timestamp time = Welcome.jdbc.resultSet.getTimestamp("time");
                model.addRow(new Object[] { username, cot, time });
            }
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(155, 220, 239));
        kGradientPanel1.setkGradientFocus(600);
        kGradientPanel1.setkStartColor(new java.awt.Color(98, 169, 215));
        ...
        jLabel9.setFont(new java.awt.Font("Comic Sans MS", 1, 66)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("COTTAGE BOOKINGS");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, -1, 70));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "USERNAME", "COTTAGE TYPE", "TIME COTTAGE BOOKED"
                }) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CottageBookings.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CottageBookings().setVisible(true);
            }
        });
    }
