 ...
 * @author USER
 */
public class CustomerRegistrations extends javax.swing.JFrame {

    /**
     * Creates new form CustomerRegistrations
     */
    ...
    public void setRecordsToTable() {
        try {
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                String nationality = Welcome.jdbc.resultSet.getString("nationality");
                String email = Welcome.jdbc.resultSet.getString("email");
                String passport = Welcome.jdbc.resultSet.getString("passport");
                String mobile = Welcome.jdbc.resultSet.getString("mobile");
                ...
                String creditcard = Welcome.jdbc.resultSet.getString("creditcard");
                String cardpin = Welcome.jdbc.resultSet.getString("cardpin");
                String gender = Welcome.jdbc.resultSet.getString("gender");
                model.addRow(
                        new Object[] { id, firstName, lastName, address, nationality, email, passport, mobile, phone,
                                username, password, creditcard, cardpin, gender });
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "ID", "FIRST NAME", "LAST NAME", "ADDRESS", "NATIONALITY", "EMAIL", "PASSPORT", "MOBILE",
                        "PHONE", "USERNAME", "PASSWORD", "CREDIT CARD", "CARD PIN", "GENDER"
                }) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerRegistrations.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerRegistrations().setVisible(true);
            }
        });
    }
