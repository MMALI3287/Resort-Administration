 ...
 * @author USER
 */
public class MoneyWithdraws extends javax.swing.JFrame {

    /**
     * Creates new form MoneyWithdraws
     */
    DefaultTableModel model = new DefaultTableModel();

    public MoneyWithdraws() {
        initComponents();
        setRecordsToTable();
    }
    ...
    public void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection
                    .prepareStatement("SELECT * FROM money;");
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                String amount = Welcome.jdbc.resultSet.getString("amount");
                model.addRow(new Object[] { username, amount });
            }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("MONEY WITHDRAWS");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, -1, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MoneyWithdraws.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MoneyWithdraws().setVisible(true);
            }
        });
    }
