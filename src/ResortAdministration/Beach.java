...
public class Beach extends javax.swing.JFrame {
    ...
    public Beach() {
        initComponents();
        try {
            imgs[0] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\beach1.jpg"));
            imgs[1] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\beach2.jpg"));
            imgs[2] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\beach3.jpg"));
    ...
    public void show(int index) {
        ...
        switch (index) {
            case 0:
                jLabel9.setText("ROCKY BEACH");
                break;
            case 1:
                jLabel9.setText("POLAR BEACH");
                break;
            case 2:
                jLabel9.setText("SUNNY BEACH");
                break;
        }
    }
