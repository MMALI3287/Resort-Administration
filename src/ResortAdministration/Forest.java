...
public class Forest extends javax.swing.JFrame {
    ...
    public Forest() {
        initComponents();
        try {
            imgs[0] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\forest1.jpg"));
            imgs[1] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\forest2.jpg"));
            imgs[2] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\forest3.jpg"));
    ...
    public void show(int index) {
        ...
        switch (index) {
            case 0:
                jLabel9.setText("BRIDGE FOREST");
                break;
            case 1:
                jLabel9.setText("RAIN FOREST");
                break;
            case 2:
                jLabel9.setText("RED FOREST");
                break;
        }
    }
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkStartColor(new java.awt.Color(250, 219, 237));
