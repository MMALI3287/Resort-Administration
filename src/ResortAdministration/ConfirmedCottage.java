 ...
 * @author USER
 */
public class ConfirmedCottage extends javax.swing.JFrame {

    /**
     * Creates new form confirmCottage
     */
    public ConfirmedCottage() {
        initComponents();
        fetchInfo();
    }
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 810, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmedCottage.class.getName()).log(java.util.logging.Level.SEVERE,
                    null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmedCottage().setVisible(true);
            }
        });
    }
