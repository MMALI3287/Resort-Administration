 ...
 * @author USER
 */
public class ConfirmCottage extends javax.swing.JFrame {

    /**
     * Creates new form confirmCottage
     */
    public ConfirmCottage() {
        initComponents();
        fetchInfo();
    }
    ...
    void fetchInfo() {
        switch (Welcome.cot) {
            case "twinBeds":
                ...
                jLabel9.setText("12,000 BDT");
                jLabel34.setText("TWO SINGLE BEDS");
                jLabel24.setText("");
                jLabel21.setText("");
                break;
            case "doubleBeds":
                jLabel10.setText("DOUBLE BEDS");
                jLabel9.setText("14,000 BDT");
                jLabel34.setText("ONE DOUBLE BED");
                jLabel24.setText("BREAKFAST INCLUDED");
                jLabel21.setText("");
                break;
            case "luxuryVilla":
                jLabel10.setText("LUXURY VILLA");
                jLabel9.setText("16,000 BDT");
                jLabel34.setText("ONE DOUBLE BED");
                jLabel24.setText("BREAKFAST INCLUDED");
                jLabel21.setText("PRIVATE BALCONY");
                break;
            case "primeVilla":
                jLabel10.setText("PRIME VILLA");
                jLabel9.setText("18,000 BDT");
                jLabel34.setText("ONE DOUBLE BED");
                jLabel24.setText("BREAKFAST INCLUDED");
                jLabel21.setText("PRIVATE LAWN");
                break;
            case "vipBed":
                jLabel10.setText("VIP BEDROOM");
                jLabel9.setText("22,000 BDT");
                jLabel34.setText("ONE DOUBLE BED");
                jLabel24.setText("BREAKFAST INCLUDED");
                jLabel21.setText("PRIVATE POOL");
                break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmCottage.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmCottage().setVisible(true);
            }
        });
    }
