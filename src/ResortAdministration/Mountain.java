...
public class Mountain extends javax.swing.JFrame {
    ...
    public Mountain() {
        initComponents();
        try {
            imgs[0] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\mountain1.jpg"));
            imgs[1] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\mountain2.jpg"));
            imgs[2] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Tour\\mountain3.jpg"));
    ...
    public void show(int index) {
        ...
        switch (index) {
            case 0:
                jLabel9.setText("RED MOUNTAIN");
                break;
            case 1:
                jLabel9.setText("MOUNTAIN RIDGE");
                break;
            case 2:
                jLabel9.setText("DESERT MOUNTAIN");
                break;
        }
    }
