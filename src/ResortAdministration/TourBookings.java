 ...
 * @author USER
 */
public class TourBookings extends javax.swing.JFrame {

    /**
     * Creates new form TourBookings
     */
    ...
    public void setRecordsToTable() {
        try {
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                String location = Welcome.jdbc.resultSet.getString("location");
                String destination = Welcome.jdbc.resultSet.getString("destination");
                int car = Welcome.jdbc.resultSet.getInt("car");
                int suv = Welcome.jdbc.resultSet.getInt("suv");
                int bus = Welcome.jdbc.resultSet.getInt("bus");
                int speedboat = Welcome.jdbc.resultSet.getInt("speedboat");
                int yacht = Welcome.jdbc.resultSet.getInt("yatch");
                int price = Welcome.jdbc.resultSet.getInt("price");
                Timestamp time = Welcome.jdbc.resultSet.getTimestamp("time");
                model.addRow(
                        new Object[] { username,  destination,location, car, suv, bus, speedboat, yacht, price, time });
            }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("TOUR BOOKINGS");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, -1, 70));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "USERNAME", "DESTINATION", "LOCATION", "CAR RESERVED", "SUV RESERVED", "BUS RESERVED", "SPEED BOAT RESERVED", "YATCH RESERVED", "TOTAL COST", "TIME RESERVED"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TourBookings.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TourBookings().setVisible(true);
            }
        });
    }
