...
public class Checkouts extends javax.swing.JFrame {
    ...
    public void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection
                    .prepareStatement("SELECT * FROM checkouts;");
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                int spent = Welcome.jdbc.resultSet.getInt("spent");
                Timestamp time = Welcome.jdbc.resultSet.getTimestamp("time");
                model.addRow(
                        new Object[] { username, review, spent, time });
            }
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(108, 242, 208));
        kGradientPanel1.setkGradientFocus(600);
        kGradientPanel1.setkStartColor(new java.awt.Color(7, 129, 150));
        ...
        jLabel9.setText("CHECKOUTS");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 30, -1, 70));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "USERNAME", "REVIEW", "TOTAL BILL", "CHECKOUT TIME"
                }) {
    ...
    private void kButton8ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_kButton8ActionPerformed
        ...
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection.prepareStatement(
                    "DELETE FROM checkouts WHERE username=?;");
