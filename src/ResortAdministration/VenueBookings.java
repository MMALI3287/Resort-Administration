 ...
 * @author USER
 */
public class VenueBookings extends javax.swing.JFrame {

    /**
     * Creates new form VenueBookings
     */
    DefaultTableModel model = new DefaultTableModel();

    public VenueBookings() {
        initComponents();
        setRecordsToTable();
    }
    ...
    public void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection
                    .prepareStatement("SELECT * FROM book_venue;");
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                String res = Welcome.jdbc.resultSet.getString("venue");
                Timestamp time = Welcome.jdbc.resultSet.getTimestamp("time");
                model.addRow(new Object[] { username, res, time });
            }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("VENUE BOOKINGS");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, -1, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VenueBookings.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VenueBookings().setVisible(true);
            }
        });
    }
