 ...
 * @author USER
 */
public class GymPasses extends javax.swing.JFrame {

    /**
     * Creates new form GymPasses
     */
    ...
    public void setRecordsToTable() {
        try {
            Welcome.jdbc.preparedStatement = Welcome.jdbc.connection
                    .prepareStatement("SELECT * FROM gym;");
            ...
            while (Welcome.jdbc.resultSet.next()) {
                ...
                Date date = Welcome.jdbc.resultSet.getDate("date");
                Time start = Welcome.jdbc.resultSet.getTime("start");
                Time end = Welcome.jdbc.resultSet.getTime("end");
                model.addRow(
                        new Object[] { username, date, start, end });
            }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("REQUESTED GYM PASSES");
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 40, -1, 70));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "USERNAME", "DATE RESERVED", "STARTING TIME", "ENDING TIME"
                }) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GymPasses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
