...
public class BookVenue extends javax.swing.JFrame {
    ...
    public BookVenue() {
        initComponents();
        try {
            imgs[0] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Resort\\poolcottage.jpg"));
            imgs[1] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Resort\\mountaincottage.jpg"));
            imgs[2] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Resort\\lakecottage.jpg"));
            imgs[3] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Resort\\halfcottage.jpg"));
            imgs[4] = ImageIO.read(new File("src\\ResortAdministration\\Images\\Resort\\fullcottage.jpg"));
    ...
    public void show(int index) {
        ...
        switch (index) {
            case 0:
                jLabel9.setText("POOL COTTAGE");
                break;
            case 1:
                jLabel9.setText("HILL COTTAGE");
                break;
            case 2:
                jLabel9.setText("LAKE COTTAGE");
                break;
            case 3:
                jLabel9.setText("HALF RESORT");
                break;
            case 4:
                jLabel9.setText("FULL RESORT");
                break;
            default:
                break;
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(114, 172, 183));
        kGradientPanel1.setkGradientFocus(600);
        kGradientPanel1.setkStartColor(new java.awt.Color(218, 229, 223));
        ...
        kGradientPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, -1, 70));
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_kButton3ActionPerformed
        ...
        switch (position) {
            case 0:
                Welcome.res = "poolCottage";
                break;
            case 1:
                Welcome.res = "mountainCottage";
                break;
            case 2:
                Welcome.res = "lakeCottage";
                break;
            case 3:
                Welcome.res = "halfCottage";
                break;
            case 4:
                Welcome.res = "fullCottage";
                break;
            default:
                break;
        }
        ConfirmVenue cottage = new ConfirmVenue();
        cottage.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookVenue.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
